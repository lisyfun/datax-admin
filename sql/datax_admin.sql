...
INSERT INTO `permissions` (`id`, `name`, `code`, `type`, `parent_id`, `path`, `component`, `icon`, `sort`, `status`, `hidden`, `cache`, `is_external`, `external_url`, `created_at`, `updated_at`, `deleted_at`, `open_type`) VALUES (20, '登录', 'login', 'menu', NULL, '/login', 'views/login/index.vue', '', 0, 1, 1, 0, 0, '', NULL, '2025-08-21 12:27:33.883', NULL, 1);
INSERT INTO `permissions` (`id`, `name`, `code`, `type`, `parent_id`, `path`, `component`, `icon`, `sort`, `status`, `hidden`, `cache`, `is_external`, `external_url`, `created_at`, `updated_at`, `deleted_at`, `open_type`) VALUES (21, '注册', 'register', 'menu', NULL, '/register', 'views/register/index.vue', '', 0, 0, 1, 0, 0, '', NULL, '2025-08-21 12:27:27.808', NULL, 1);
