...
CREATE TABLE `jobs` (
  ...
  `cron_expr` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `permissions` (
  ...
  `component` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='权限表（包含菜单和按钮权限）';
...
INSERT INTO `permissions` (`id`, `name`, `code`, `type`, `parent_id`, `path`, `component`, `icon`, `sort`, `status`, `hidden`, `cache`, `created_at`, `updated_at`, `deleted_at`) VALUES (2, '仪表盘', 'dashboard', 'menu', 1, 'dashboard', 'views/dashboard/index.vue', 'icon-dashboard', 0, 1, 0, 1, NULL, NULL, NULL);
...
INSERT INTO `permissions` (`id`, `name`, `code`, `type`, `parent_id`, `path`, `component`, `icon`, `sort`, `status`, `hidden`, `cache`, `created_at`, `updated_at`, `deleted_at`) VALUES (9, '工具箱', 'tools', 'menu', 1, 'tools', 'views/tools/index.vue', 'icon-common', 4, 1, 0, 1, NULL, '2025-06-19 21:59:52.790', NULL);
...
INSERT INTO `permissions` (`id`, `name`, `code`, `type`, `parent_id`, `path`, `component`, `icon`, `sort`, `status`, `hidden`, `cache`, `created_at`, `updated_at`, `deleted_at`) VALUES (12, 'Kafka管理', 'tools.kafka', 'menu', 1, 'kafka', 'views/kafka/index.vue', 'icon-apps', 3, 1, 0, 1, NULL, NULL, NULL);
