...
func createDefaultPermissions(tx *gorm.DB) error {
	permissions := []Permission{
		...
		{ID: 10, Name: "Json格式化", Code: "tools.json-formatter", Type: "menu", ParentID: uintPtr(9), Path: "json-formatter", Component: "views/tools/JsonFormatter.vue", Icon: "icon-code", Sort: 0, Status: 1, Hidden: 0, Cache: 1},
		...
		{ID: 16, Name: "系统管理", Code: "system", Type: "menu", ParentID: uintPtr(1), Path: "system", Component: "views/system/index.vue", Icon: "icon-apps", Sort: 999, Status: 1, Hidden: 0, Cache: 1},
